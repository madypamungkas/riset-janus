...
public class VideoroomActvity extends AppCompatActivity implements ServiceDelegate{
    class Room {
        public long room;
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_videoroom_actvity);
    ...
    public void onEvent(JanusEvent event, com.github.helloiampau.janus.generated.Bundle payload) {
        ...
        if(publishers.size() > 0) {
            for(JanusData publisher : publishers) {
                Bundle payload2 = Bundle.create();
                payload2.setInt("room", this._selectedRoom);
                payload2.setInt("feed", publisher.getInt("id", -1));
